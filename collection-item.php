               ...
               <div class="row justify-content-center mb-4">
                  ...
                  <div class="col-lg-7 col-xl-7">
                     ...
                     <div class="card-item-details mb-5">
                        <div class="item-details__badge badge__green mb-4">For Sale</div>
                     ...
                     <div class="card-item-details border bg-soft p-4 rounded mb-4">
                        <div class="d-flex align-items-center mb-2">
                           ...
                           <span class="price-item__ton d-block ms-auto">43.9 TON</span>
                        </div>
                        ...
                        <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#BuyNowModal">Buy Now</button>
                     </div>
                     <!-- // End Price Card -->
                     ...
                     <div class="row">
                        ...
                        <div class="col-xl-6 mb-4">
                           <a href="/collection.php" class="card-item-details d-block border bg-soft hover px-4 py-3 rounded text-white">
