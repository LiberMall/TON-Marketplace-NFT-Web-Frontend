            ...
            <div class="col-lg-4 col-xl-4 col-xxl-3 mb-4 mb-lg-0">
               ...
               <div class="card card-blur p-0 mt--100">
                  <div class="card__share d-flex position-absolute" style="top: 8px; right: 8px">
                     <button class="btn btn-cube" type="button" data-bs-toggle="modal" data-bs-target="#ShareModal"><i class="fa-regular fa-share-nodes"></i></button>
                     <div class="dropdown">
                  ...
                  <div class="card-body p-4 p-lg-2 p-xl-3 p-xxl-4">
                     <div class="d-flex flex-column flex-md-row flex-lg-column align-items-center mb-5">
                        ...
                        <div class="d-flex mx-0 mx-lg-auto">
                           ...
                           <a href="#!" class="btn btn-sm btn-soft" data-bs-toggle="modal" data-bs-target="#MessageModal" data-bs-whatever="@Tegro">Message</a>
                        </div>
                     </div>
               ...
               <div class="overflow-auto mobile__nav-bottom mb-4 px-2" id="mouseScroll">
                  <ul class="nav collections__nav list-unstyled d-flex flex-nowrap align-items-center" id="myTab" role="tablist">
                     <li class="collections__nav-item">
                        <button class="collections__nav-link d-flex align-items-center text-nowrap active" id="Owned-tab" data-bs-toggle="tab" data-bs-target="#Owned" type="button" role="tab" aria-controls="Owned" aria-selected="true">Owned <span class="badge bg-grey ms-2">25</span></button>
                     </li>
                     <li class="collections__nav-item ">
                        <button class="collections__nav-link d-flex align-items-center text-nowrap" id="Onsale-tab" data-bs-toggle="tab" data-bs-target="#Onsale" type="button" role="tab" aria-controls="Onsale" aria-selected="false">On sale <span class="badge bg-grey ms-2">24</span></button>
                     </li>
                     <li class="collections__nav-item">
                        <button class="collections__nav-link d-flex align-items-center text-nowrap" id="Created-tab" data-bs-toggle="tab" data-bs-target="#Created" type="button" role="tab" aria-controls="Created" aria-selected="false">Created <span class="badge bg-grey ms-2">24</span></button>
                     </li>
                     <li class="collections__nav-item">
                     ...
                     <li class="collections__nav-item">
                        <button class="collections__nav-link d-flex align-items-center text-nowrap" id="Sold-tab" data-bs-toggle="tab" data-bs-target="#Sold" type="button" role="tab" aria-controls="Sold" aria-selected="false">Sold <span class="badge bg-grey ms-2">11</span></button>
                     </li>
