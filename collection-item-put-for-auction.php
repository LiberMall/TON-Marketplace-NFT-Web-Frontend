               ...
               <div class="row justify-content-center mb-4">
                  ...
                  <div class="col-lg-7 col-xl-7">
                     ...
                     <div class="card-item-details mb-5">
                        <div class="item-details__badge badge__purple mb-4">On the auction</div>
                     ...
                     <!-- // End Action Link -->
                     <!-- Start Price Card -->
                     <div class="card-item-details border bg-soft p-4 rounded mb-4">
                        <div class="d-flex align-items-center mb-4">
                           <h4 class="fw-bold fs-16 mb-0">Bets are no longer accepted</h4>
                           <a href="#!" class="color-yellow ms-auto">How it works</a>
                        </div>
                        <div class="alert alert-warning d-flex">
                           <span class="fs-28 me-3">😔</span>
                           <div>
                              <h5 class="fw-bold fs-16">There were no bids</h5>
                              <p class="mb-0">The auction has ended, but there were no bids. It's a pity! <br> You can always try again.</p>
                           </div>
                        </div>
                        <button type="button" class="btn btn-primary flex-fill m-2 w-100" data-bs-toggle="modal" data-bs-target="#EndAuctionModal">End auction</button>
                     </div>
                     <!-- // End Price Card -->
